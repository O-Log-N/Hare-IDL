...
// ASSERT-EQUAL
inline void assertEqualTestClass( const TestClass& left, const TestClass& right );
...
// ASSERT-EQUAL-2-GPB
inline void assertEqualTestClass( const TestClass& left, const pb::TestClass& right );
