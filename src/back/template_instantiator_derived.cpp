...
/*		case PLACEHOLDER::IDL_MEMBER_TYPE:
		{
...
void RootTemplateInstantiator::execBuiltinFunction( Stack& stack, PredefindedFunction fn )
{
	switch ( fn.id )
	{
		case PREDEFINED_FUNCTION::PUBLISHABLE_STRUCTS:
		...
		default:
		{
			TemplateInstantiator::execBuiltinFunction( stack, fn );
			break;
		}
	}
}
