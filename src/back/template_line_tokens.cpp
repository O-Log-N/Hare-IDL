...
#define PLACEHOLDER_STRING_MEMBER_MAPPING_TYPE "MEMBER-MAPPING-TYPE"
...
const PlaceholderWord placeholders[] = 
{
	...
	{PLACEHOLDER_STRING_MEMBER_MAPPING_TYPE, sizeof(PLACEHOLDER_STRING_MEMBER_MAPPING_TYPE)-1, PLACEHOLDER::MEMBER_MAPPING_TYPE},
