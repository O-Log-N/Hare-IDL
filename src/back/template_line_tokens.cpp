...
#define KEYWORD_STRING_COMMENTED_LINE "-"
...
#define NODETYPE_STRING_FOR_SINGLE_ENTER_BLOCK "FOR-SINGLE-ENTER-BLOCK"
#define NODETYPE_STRING_FOR_SINGLE_INCLUDE_TEMPLATE "FOR-SINGLE-INCLUDE-TEMPLATE"
#define NODETYPE_STRING_FOR_EACH "FOR-EACH"

// predefined functions
#define FUNCTION_STRING_HAS_VALUE "HAS-VALUE"
// type-checkers
#define FUNCTION_STRING_IS_ROOT "IS-ROOT"
#define FUNCTION_STRING_IS_SERIALIZABLE_OBJECT "IS-SERIALIZABLE-OBJECT"
#define FUNCTION_STRING_IS_MEMBER_TYPE "IS-MEMBER-TYPE"
#define FUNCTION_STRING_IS_MEMBER "IS-MEMBER"
#define FUNCTION_STRING_IS_ENUM_VALUE "IS-ENUM-VALUE"
#define FUNCTION_STRING_IS_DU_OPTION "IS-DU-OPTION"

// former placeholders, now context-dependent calls
#define FUNCTION_STRING_STRUCT_NAME "STRUCT-NAME"
#define FUNCTION_STRING_IDL_MEMBER_TYPE "IDL-MEMBER-TYPE"
#define FUNCTION_STRING_MAPPING_MEMBER_TYPE "MAPPING-MEMBER-TYPE"
#define FUNCTION_STRING_ENCODING_MEMBER_TYPE "ENCODING-MEMBER-TYPE"
#define FUNCTION_STRING_MAPPING_DISCRIMINATOR_NAME "MAPPING-DISCRIMINATOR-NAME"
#define FUNCTION_STRING_IDL_MEMBER_NAME "IDL-MEMBER-NAME"
#define FUNCTION_STRING_MAPPING_MEMBER_NAME "MAPPING-MEMBER-NAME"
#define FUNCTION_STRING_ENCODING_MEMBER_NAME "ENCODING-MEMBER-NAME"
#define FUNCTION_STRING_ENUM_VALUE_NAME "ENUM-VALUE-NAME"
#define FUNCTION_STRING_ENCODING_ENUM_VALUE_VALUE "ENCODING-ENUM-VALUE-VALUE"
#define FUNCTION_STRING_MAPPING_ENUM_VALUE_VALUE "MAPPING-ENUM-VALUE-VALUE"
#define FUNCTION_STRING_ENCODING_DISCRIMINATED_UNION_OPTION_NAME "ENCODING-DISCRIMINATED-UNION-OPTION-NAME"
#define FUNCTION_STRING_ENCODING_DISCRIMINATED_UNION_OPTION_VALUE "ENCODING-DISCRIMINATED-UNION-OPTION-VALUE"
#define FUNCTION_STRING_MAPPING_DISCRIMINATED_UNION_OPTION_VALUE "MAPPING-DISCRIMINATED-UNION-OPTION-VALUE"

#define FUNCTION_STRING_MAPPING_MEMBER_NAME "MAPPING-MEMBER-NAME"
#define FUNCTION_STRING_MEMBERS "MEMBERS"
#define FUNCTION_STRING_PUBLISHABLE_STRUCTS "PUBLISHABLE-STRUCTS"
#define FUNCTION_STRING_PUBLISHABLE_DISCRIMINATED_UNIONS "PUBLISHABLE-DISCRIMINATED-UNIONS"
#define FUNCTION_STRING_DISCRIMINATED_UNION_DISCRIMINATOR "DISCRIMINATED-UNION-DISCRIMINATOR"
#define FUNCTION_STRING_DISCRIMINATED_UNION_OPTIONS "DISCRIMINATED-UNION-OPTIONS"
...
//#define FUNCTION_STRING_DISCRIMINATED_UNION_ALLOWED_PAIRS "DISCRIMINATED-UNION-ALLOWED-PAIRS"
// type-related
...
#define FUNCTION_STRING_INSERT_TO_MAP "INSERT-TO-MAP"
#define FUNCTION_STRING_FIND_IN_MAP "FIND-IN-MAP"
...
const NodeType nodeTypes[] = 
{
	...
	{KEYWORD_STRING_RETURN, NODE_TYPE::RETURN},
	{NODETYPE_STRING_FOR_EACH, NODE_TYPE::FOR_EACH},
	{NULL, NODE_TYPE::CONTENT},
};

const KeyWord keywords[] = 
{
	{KEYWORD_STRING_COMMENTED_LINE, sizeof(KEYWORD_STRING_COMMENTED_LINE)-1, TemplateLine::LINE_TYPE::COMMENTED_LINE, false},
	...
	{KEYWORD_STRING_RETURN, sizeof(KEYWORD_STRING_RETURN)-1, TemplateLine::LINE_TYPE::RETURN, true},
	{KEYWORD_STRING_FOR_EACH, sizeof(KEYWORD_STRING_FOR_EACH)-1, TemplateLine::LINE_TYPE::FOR_EACH, true},
...
const ParameterWord params[] = 
{
	...
	{PARAM_STRING_IN, sizeof(PARAM_STRING_IN)-1, ATTRIBUTE::IN},
...
{
// type-checkers
	{FUNCTION_STRING_IS_ROOT, sizeof(FUNCTION_STRING_IS_ROOT)-1, PREDEFINED_FUNCTION::IS_ROOT, 1, false, false},
	{FUNCTION_STRING_IS_SERIALIZABLE_OBJECT, sizeof(FUNCTION_STRING_IS_SERIALIZABLE_OBJECT)-1, PREDEFINED_FUNCTION::IS_SERIALIZABLE_OBJECT, 1, false, false},
	{FUNCTION_STRING_IS_MEMBER_TYPE, sizeof(FUNCTION_STRING_IS_MEMBER_TYPE)-1, PREDEFINED_FUNCTION::IS_MEMBER_TYPE, 1, false, false},
	{FUNCTION_STRING_IS_MEMBER, sizeof(FUNCTION_STRING_IS_MEMBER)-1, PREDEFINED_FUNCTION::IS_MEMBER, 1, false, false},
	{FUNCTION_STRING_IS_ENUM_VALUE, sizeof(FUNCTION_STRING_IS_ENUM_VALUE)-1, PREDEFINED_FUNCTION::IS_ENUM_VALUE, 1, false, false},
	{FUNCTION_STRING_IS_DU_OPTION, sizeof(FUNCTION_STRING_IS_DU_OPTION)-1, PREDEFINED_FUNCTION::IS_DU_OPTION, 1, false, false},

	{FUNCTION_STRING_STRUCT_NAME, sizeof(FUNCTION_STRING_STRUCT_NAME)-1, PREDEFINED_FUNCTION::STRUCT_NAME, 0, true, true},
	{FUNCTION_STRING_IDL_MEMBER_TYPE, sizeof(FUNCTION_STRING_IDL_MEMBER_TYPE)-1, PREDEFINED_FUNCTION::IDL_MEMBER_TYPE, 0, true, true},
	{FUNCTION_STRING_MAPPING_MEMBER_TYPE, sizeof(FUNCTION_STRING_MAPPING_MEMBER_TYPE)-1, PREDEFINED_FUNCTION::MAPPING_MEMBER_TYPE, 0, true, true},
	{FUNCTION_STRING_ENCODING_MEMBER_TYPE, sizeof(FUNCTION_STRING_ENCODING_MEMBER_TYPE)-1, PREDEFINED_FUNCTION::ENCODING_MEMBER_TYPE, 0, true, true},
	{FUNCTION_STRING_MAPPING_DISCRIMINATOR_NAME, sizeof(FUNCTION_STRING_MAPPING_DISCRIMINATOR_NAME)-1, PREDEFINED_FUNCTION::MAPPING_DISCRIMINATOR_NAME, 0, true, true},
	{FUNCTION_STRING_IDL_MEMBER_NAME, sizeof(FUNCTION_STRING_IDL_MEMBER_NAME)-1, PREDEFINED_FUNCTION::IDL_MEMBER_NAME, 0, true, true},
	{FUNCTION_STRING_MAPPING_MEMBER_NAME, sizeof(FUNCTION_STRING_MAPPING_MEMBER_NAME)-1, PREDEFINED_FUNCTION::MAPPING_MEMBER_NAME, 0, true, true},
	{FUNCTION_STRING_ENCODING_MEMBER_NAME, sizeof(FUNCTION_STRING_ENCODING_MEMBER_NAME)-1, PREDEFINED_FUNCTION::ENCODING_MEMBER_NAME, 0, true, true},
	{FUNCTION_STRING_ENUM_VALUE_NAME, sizeof(FUNCTION_STRING_ENUM_VALUE_NAME)-1, PREDEFINED_FUNCTION::ENUM_VALUE_NAME, 0, true, true},
	{FUNCTION_STRING_ENCODING_ENUM_VALUE_VALUE, sizeof(FUNCTION_STRING_ENCODING_ENUM_VALUE_VALUE)-1, PREDEFINED_FUNCTION::ENCODING_ENUM_VALUE_VALUE, 0, true, true},
	{FUNCTION_STRING_MAPPING_ENUM_VALUE_VALUE, sizeof(FUNCTION_STRING_MAPPING_ENUM_VALUE_VALUE)-1, PREDEFINED_FUNCTION::MAPPING_ENUM_VALUE_VALUE, 0, true, true},
	{FUNCTION_STRING_ENCODING_DISCRIMINATED_UNION_OPTION_NAME, sizeof(FUNCTION_STRING_ENCODING_DISCRIMINATED_UNION_OPTION_NAME)-1, PREDEFINED_FUNCTION::ENCODING_DISCRIMINATED_UNION_OPTION_NAME, 0, true, true},
	{FUNCTION_STRING_ENCODING_DISCRIMINATED_UNION_OPTION_VALUE, sizeof(FUNCTION_STRING_ENCODING_DISCRIMINATED_UNION_OPTION_VALUE)-1, PREDEFINED_FUNCTION::ENCODING_DISCRIMINATED_UNION_OPTION_VALUE, 0, true, true},
	{FUNCTION_STRING_MAPPING_DISCRIMINATED_UNION_OPTION_VALUE, sizeof(FUNCTION_STRING_MAPPING_DISCRIMINATED_UNION_OPTION_VALUE)-1, PREDEFINED_FUNCTION::MAPPING_DISCRIMINATED_UNION_OPTION_VALUE, 0, true, true},

	{FUNCTION_STRING_MEMBERS, sizeof(FUNCTION_STRING_MEMBERS)-1, PREDEFINED_FUNCTION::MEMBERS, 0, true, true},
	{FUNCTION_STRING_PUBLISHABLE_STRUCTS, sizeof(FUNCTION_STRING_PUBLISHABLE_STRUCTS)-1, PREDEFINED_FUNCTION::PUBLISHABLE_STRUCTS, 0, true, true},
	{FUNCTION_STRING_MEMBER_TYPE, sizeof(FUNCTION_STRING_MEMBER_TYPE)-1, PREDEFINED_FUNCTION::MEMBER_TYPE, 0, true, true},
	{FUNCTION_STRING_COLLECTION_TYPE2, sizeof(FUNCTION_STRING_COLLECTION_TYPE2)-1, PREDEFINED_FUNCTION::COLLECTION_TYPE2, 0, true, true},
	{FUNCTION_STRING_COLLECTION_TYPE, sizeof(FUNCTION_STRING_COLLECTION_TYPE)-1, PREDEFINED_FUNCTION::COLLECTION_TYPE, 0, true, true},
	{FUNCTION_STRING_ENUM_VALUES, sizeof(FUNCTION_STRING_ENUM_VALUES)-1, PREDEFINED_FUNCTION::ENUM_VALUES, 0, true, true},
	{FUNCTION_STRING_PUBLISHABLE_DISCRIMINATED_UNIONS, sizeof(FUNCTION_STRING_PUBLISHABLE_DISCRIMINATED_UNIONS)-1, PREDEFINED_FUNCTION::PUBLISHABLE_DISCRIMINATED_UNIONS, 0, true, true},
	{FUNCTION_STRING_DISCRIMINATED_UNION_DISCRIMINATOR, sizeof(FUNCTION_STRING_DISCRIMINATED_UNION_DISCRIMINATOR)-1, PREDEFINED_FUNCTION::DISCRIMINATED_UNION_DISCRIMINATOR, 0, true, true},
	{FUNCTION_STRING_DISCRIMINATED_UNION_OPTIONS, sizeof(FUNCTION_STRING_DISCRIMINATED_UNION_OPTIONS)-1, PREDEFINED_FUNCTION::DISCRIMINATED_UNION_OPTIONS, 0, true, true},
// type-related
	{FUNCTION_STRING_IS_STRUCTURE, sizeof(FUNCTION_STRING_IS_STRUCTURE)-1, PREDEFINED_FUNCTION::IS_STRUCTURE, 0, true, true},
	{FUNCTION_STRING_IS_ENUM, sizeof(FUNCTION_STRING_IS_ENUM)-1, PREDEFINED_FUNCTION::IS_ENUM, 0, true, true},
	{FUNCTION_STRING_IS_SEQUENCE, sizeof(FUNCTION_STRING_IS_SEQUENCE)-1, PREDEFINED_FUNCTION::IS_SEQUENCE, 0, true, true},
	{FUNCTION_STRING_IS_DICTIONARY, sizeof(FUNCTION_STRING_IS_DICTIONARY)-1, PREDEFINED_FUNCTION::IS_DICTIONARY, 0, true, true},
	{FUNCTION_STRING_IS_INTEGER, sizeof(FUNCTION_STRING_IS_INTEGER)-1, PREDEFINED_FUNCTION::IS_INTEGER, 0, true, true},
	{FUNCTION_STRING_IS_FIXED_POINT, sizeof(FUNCTION_STRING_IS_FIXED_POINT)-1, PREDEFINED_FUNCTION::IS_FIXED_POINT, 0, true, true},
	{FUNCTION_STRING_IS_UNSIGNED_INTEGER_FITTING_UINT, sizeof(FUNCTION_STRING_IS_UNSIGNED_INTEGER_FITTING_UINT)-1, PREDEFINED_FUNCTION::IS_UNSIGNED_INTEGER_FITTING_UINT, 1, true, true},
	{FUNCTION_STRING_IS_SIGNED_INTEGER_FITTING_INT, sizeof(FUNCTION_STRING_IS_SIGNED_INTEGER_FITTING_INT)-1, PREDEFINED_FUNCTION::IS_SIGNED_INTEGER_FITTING_INT, 1, true, true},
	{FUNCTION_STRING_IS_UNSIGNED_INTEGER, sizeof(FUNCTION_STRING_IS_UNSIGNED_INTEGER)-1, PREDEFINED_FUNCTION::IS_UNSIGNED_INTEGER, 0, true, true},
	{FUNCTION_STRING_IS_FLOATING_POINT_FITTING_FLOAT, sizeof(FUNCTION_STRING_IS_FLOATING_POINT_FITTING_FLOAT)-1, PREDEFINED_FUNCTION::IS_FLOATING_POINT_FITTING_FLOAT, 2, true, true},
	{FUNCTION_STRING_IS_FLOATING_POINT, sizeof(FUNCTION_STRING_IS_FLOATING_POINT)-1, PREDEFINED_FUNCTION::IS_FLOATING_POINT, 0, true, true},
	{FUNCTION_STRING_IS_CHARACTER_STRING, sizeof(FUNCTION_STRING_IS_CHARACTER_STRING)-1, PREDEFINED_FUNCTION::IS_CHARACTER_STRING, 0, true, true},
...
// map creation and manipulation
	{FUNCTION_STRING_CREATE_MAP, sizeof(FUNCTION_STRING_CREATE_MAP)-1, PREDEFINED_FUNCTION::CREATE_MAP, 0, false, false},
	{FUNCTION_STRING_INSERT_TO_MAP, sizeof(FUNCTION_STRING_INSERT_TO_MAP)-1, PREDEFINED_FUNCTION::INSERT_TO_MAP, 2, true, false},
	{FUNCTION_STRING_FIND_IN_MAP, sizeof(FUNCTION_STRING_FIND_IN_MAP)-1, PREDEFINED_FUNCTION::FIND_IN_MAP, 1, true, false},
